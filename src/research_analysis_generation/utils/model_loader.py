...
from research_analysis_generation.utils.config_loader import load_config
...
class ModelLoader:
    ...
    def __init__(self):
        ...
        try:
            ...
            raise ResearchAnalysisException("Failed to initialize ModelLoader", sys)

    def load_embeddings(self):
        """
        Load and return an OpenAI embedding model.

        Returns:
            OpenAIEmbeddings: Loaded embedding model instance.
        """
        try:
            model_name = self.config["embedding_model"]["model"]
            if not model_name:
                raise ValueError("Embedding model name missing in config")
    ...
    def load_llm(self):
        ...
        Returns:
            ChatOpenAI | ChatGroq: LLM instance
        """
        try:
            ...
            raise ResearchAnalysisException("Failed to load LLM", sys)
...
if __name__ == "__main__":
    ...
    except ResearchAnalysisException as e:
